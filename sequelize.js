...
const TournamentMatchPlayerScore = TournamentMatchPlayerScoreModel(
  sequelize,
  Sequelize
);
...
TournamentPoint.belongsTo(Tournament, {
  foreignKey: "tournamentId",
  as: "Tournament"
});
...
TournamentMatchPlayerScore.hasMany(Tournament, {
  foreignKey: "id",
  sourceKey: "tournamentId"
});
TournamentMatchPlayerScore.belongsTo(Player, {
  foreignKey: "playerId",
  sourceKey: "id"
});

UserPlayer.hasMany(TournamentMatch, {
  foreignKey: "id",
  sourceKey: "tournamentMatchId"
});
